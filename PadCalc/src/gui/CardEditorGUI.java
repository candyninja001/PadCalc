...
public class CardEditorGUI extends JFrame implements ActionListener, FocusListener {
	public Card card; 
	...
	public CardEditorGUI(){
		card = new Card((Monster)null);
		initComponents();
	}
	
	public CardEditorGUI(Card c){
		card = c;
		initComponents();
	}
	...
	private void initComponents() {
	    ...
	    plusPanel.add(new JLabel("Pluses:"));
